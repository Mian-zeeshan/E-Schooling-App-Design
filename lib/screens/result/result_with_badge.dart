...
class ResultWithBadges extends StatelessWidget {
  double rating = 4.5;
  int reviews = 30, video = 12, quizes = 04, badges = 02;

  ResultWithBadges({super.key});
                  ...
                  child: Padding(
                    ...
                    child: Row(children: [
                      ...
                      Column(
                        ...
                        children: [
                          text('WOHOO!', size: 24.0, fontWeight: FontWeight.w700),
                          text('You have earned a badge.',
                              size: 18.0, fontWeight: FontWeight.w400, color: const Color(0xffAFAFAF))
                        ],
                      )
                    ]),
                  ),
