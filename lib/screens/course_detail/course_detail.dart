...
import '../course_start/start_course_screen.dart';
        ...
        child: Stack(
          children: [
            Container(
              ...
              child: Image.asset('asset/images/bgimage.png',
                  fit: BoxFit.cover, isAntiAlias: false, filterQuality: FilterQuality.high),
            ),
            Positioned(
              bottom: 0,
              right: 0,
              ...
              left: 0,
               child: Padding(
                     ...
                     child: Container(
                       ...
                       child: Center(child: text('Start Now',color: kWhiteColor,size: 20.0,fontWeight: FontWeight.w500),)),
                     ),
                   ),
             ),
          ],
